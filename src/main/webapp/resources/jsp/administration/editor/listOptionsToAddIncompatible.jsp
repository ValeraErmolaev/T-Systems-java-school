...
<nav class="navbar navbar-dark bg-dark">
    ...
    <a href="/administration/editor/option/${currentOption.id}">Back</a>
...
<table class="table table-bordered">
    ...
    <c:if test="${options.size() !=0}" >
        ...
        <c:forEach items="${options}" var="option">
            <tr>
                <c:choose>
                    <c:when test="${currentOption.incompatibledOptions.contains(option) == false && currentOption != option }">
                        ...
                        <td>
                            <form action = "/administration/editor/option/${currentOption.id}/addIncompatibleOption/${option.id}" method = "post">
