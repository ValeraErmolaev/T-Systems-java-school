...
<table class="table table-bordered">
    ...
    <c:if test="${options.size() !=0}" >
        ...
        <c:forEach items="${options}" var="option">
            <tr>
                <c:choose>
                    <c:when test="${currentOption.associatedOptions.contains(option) == false && currentOption != option }">
                        ...
                        <td>
                            <form action = "/administration/editor/option/${currentOption.id}/addOption/${option.id}" method = "post">
